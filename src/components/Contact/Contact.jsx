const Contact = () => {
    return(
        <div id='contact' className="grid justify-items-center">
            ...
            <p className="font-bold pb-10 md:text-lg sm:(text-sm pb-5)">Actualmente estoy buscando empleo, me considero una persona activa y que puedo dar lo mejor de mi para lograr soluciones eficaces, por lo que dejo mis medios de contacto por si gustas contactarme para empleo o para conocerme.</p>
