    ...
    return(
        <div id='techs' className="xl:(grid grid-cols-2 p-10 mb-20)">
            <div className="grid xl:(p-10 m-6 grid-rows-4) md:(p-5 m-3)">
                <span className="font-bold text-sky-400 underline text-left xl:text-5xl md:(text-3xl text-center pb-5)">Techs skills</span>
                <span className="font-bold text-left md:(text-lg)">Todas estas tecnologias, exceptuando algunas, las aprendi en el bootcamp de Henry. <br />Donde ademas de aprenderlas, tuve projectos en los cuales pude aprendir Git-flow, saber como se maneja de forma correcta git, una buena comunicación con mi equipo, aportar ideas, tener reuniones diarias y una flexibilidad de horarios.</span>
            </div>
            <div className="grid grid-cols-4 xl:(gap-4 p-10) md:(gap-2 p-5)"> 
