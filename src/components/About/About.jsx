    ...
    return(
        <div id='about' className="xl:p-10 md:p-5">
            <div className="grid p-10 m-6">
                <span className="font-bold text-sky-400 underline text-left pb-10 xl:text-5xl md:(text-3xl text-center) sm:(text-2xl text-center)">About me</span>
                <div className="font-bold grid xl:grid-cols-2 md:grid-rows-2">
                    ...
                    <div className='xl:px-30 md:pt-5 sm:pt-5'>
